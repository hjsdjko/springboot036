...
public class ShouyinyuanController {
	...
	public R login(String username, String password, String captcha, HttpServletRequest request) {
		ShouyinyuanEntity u = shouyinyuanService.selectOne(new EntityWrapper<ShouyinyuanEntity>().eq("gonghao", username));
		if(u==null || !u.getMima().equals(password)) {
			return R.error("账号或密码不正确");
		}
		
		String token = tokenService.generateToken(u.getId(), username,"shouyinyuan",  "收银员" );
    ...
    public R register(@RequestBody ShouyinyuanEntity shouyinyuan){
    	...
    	ShouyinyuanEntity u = shouyinyuanService.selectOne(new EntityWrapper<ShouyinyuanEntity>().eq("gonghao", shouyinyuan.getGonghao()));
		if(u!=null) {
    ...
    public R getCurrUser(HttpServletRequest request){
        ...
        ShouyinyuanEntity u = shouyinyuanService.selectById(id);
    ...
    public R resetPass(String username, HttpServletRequest request){
        ...
        u.setMima("123456");
        shouyinyuanService.updateById(u);
    ...
    public R save(@RequestBody ShouyinyuanEntity shouyinyuan, HttpServletRequest request){
        if(shouyinyuanService.selectCount(new EntityWrapper<ShouyinyuanEntity>().eq("gonghao", shouyinyuan.getGonghao()))>0) {
    ...
    public R update(@RequestBody ShouyinyuanEntity shouyinyuan, HttpServletRequest request){
        //ValidatorUtils.validateEntity(shouyinyuan);
        if(shouyinyuanService.selectCount(new EntityWrapper<ShouyinyuanEntity>().ne("id", shouyinyuan.getId()).eq("gonghao", shouyinyuan.getGonghao()))>0) {
            return R.error("工号已存在");
        }
